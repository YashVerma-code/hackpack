import { newStyles, nextMiddleware, nextsignInCss, nextSignInPage, nextsignUpCss, nextSignUpPage, clerkUserModel, clerkUserController, clerkWebhookRoute, printStepsToConsole } from "./utility.js";
        ...
        try {
            ...
            if (currentDir !== targetDir) {
                if (fs.existsSync(targetDir)) {
                    ...
                    console.error(chalk.yellow(`Directory "${projectName}" does not exist.`));
                }
            }
            ...
            if (fs.existsSync(srcDir)) {
                ...
                if (database === 'mongodb') {
                    try {
                        ...
                        const webhookContent = clerkWebhookRoute ? clerkWebhookRoute('next', language) : '';
                        ...
                        const controllerContent = clerkUserController ? clerkUserController('next' ,language) : '';
