export function createWelcomePageHTML(useTailwind) {
  ...
  <div class="min-h-screen relative overflow-hidden bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 "
    ...
    <div class="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 text-center">
      ...
      <!-- DaisyUI Button -->
      <button @click="handleWelcomeClick"
        class="btn btn-primary btn-lg bg-gradient-to-r from-cyan-500 to-blue-600 border-none text-white font-bold px-8 py-4 rounded-2xl shadow-2xl hover:shadow-cyan-500/25 transform hover:scale-105 transition-all duration-300 fade-up opacity-0 translate-y-8 delay-2000">
    ...
    <div v-if="showToast" class="toast toast-bottom toast-end z-50">
      <div class="alert alert-success shadow-2xl border-none bg-gradient-to-r from-green-400 to-emerald-500">
        <div class="flex items-center">
          ...
          <div>
            <div class="font-bold text-white">Welcome to HackPack!</div>
            <div class="text-sm text-green-100">Your coding adventure begins now! 🎉</div>
          </div>
        </div>
      </div>
    </div>
        ...
        <Transition name="toast">
            <div v-if="showToast" class="toast">
                <div class="toast-content">
                    ...
                    <div>
                        <div class="toast-title">Welcome to HackPack!</div>
                        <div class="toast-message">Your coding adventure begins now! 🎉</div>
                    </div>
                </div>
            </div>
        </Transition>
