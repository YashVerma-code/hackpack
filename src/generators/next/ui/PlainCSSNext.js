...
export class PlainCSSNext extends BaseUILibrary {
  static id = 'plain';
...
`;
      ...
      const toasterPath = path.join(uiComponentsDir, `toaster.${this.language === 'ts' ? 'tsx' : 'js'}`);
      ...
      const layoutPath = `src/app/layout.${this.language === 'ts' ? 'tsx' : 'js'}`;
    ...
    <main>
      <div className="welcome-card">
        ...
        <p className="welcome-desc">
          Build Fast, Ship Faster! 🚀<br />This project is set up with Next.js and plain CSS.
        </p>
        <button className="welcome-btn" onClick={handleClick}>
          Click me for a toast notification: {count}
        </button>
        <p className="welcome-edit">
          Edit <span className="welcome-code">src/app/${editFile}</span> to get started
        </p>
      </div>
    </main>
    </>
