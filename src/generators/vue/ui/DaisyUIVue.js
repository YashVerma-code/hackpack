...
export class DaisyUIVue extends BaseUILibrary {
  static id = 'daisyui';
  ...
  async setup() {
    ...
    try {
      await execa('npm', ['install', 'daisyui@latest'], { stdio: 'inherit', shell: true });
...
.typewriter {
  display: inline-block; overflow: hidden; border-right: 2px solid white;
