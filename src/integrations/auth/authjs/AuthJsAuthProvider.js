...
import { appBarContent, authFileContent, isFrameworkSupported, middlewareContent } from "../../../../lib/authentication/utils/utility.js";

export class AuthJsAuthProvider extends BaseAuthProvider {
  static id = 'authjs';
  static displayName = 'Auth.js (Next only)';
  static supportedFrameworks = ['next'];
